...
(function() {
  ...
  function initTheme() {
    ...
    document.addEventListener('click', function(e) {
      ...
      setTheme(next);
      // If Plotly is already loaded (unlikely on non‑home pages), re‑render charts
  ...
  // Expose for inline usage (if any) – but we will remove inline onclick
  ...
  // Expose initCore globally if needed
